"""
Django settings for nestprj project.
...
SECRET_KEY = 'django-insecure-04s0c)vh#(ha-q^erf77-9felqc=!-adeget(y9z6&yrcygx4c'
...
WSGI_APPLICATION = 'nestprj.wsgi.application'
